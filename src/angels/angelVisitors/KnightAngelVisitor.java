...
public class KnightAngelVisitor implements AngelVisitor {
    ...
    private static final int GOOD_BOY_HEAL = 20;

    private static final float LEVEL_UP_ANGEL_MODIFIER = 0.1f;

    private static final int LIFE_GIVER_HEAL = 100;

    private static final float SMALL_ANGEL_MODIFIER = 0.1f;
    private static final int SMALL_ANGEL_HEAL = 10;

    private static final int SPAWNER_RESURRECT_HEALTH = 200;

    private static final int XP_ANGEL_BONUS_XP = 45;
