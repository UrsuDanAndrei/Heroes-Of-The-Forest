...
public final class PyromancerAngelVisitor implements  AngelVisitor {
    private static PyromancerAngelVisitor instance = null;

    private static final float DAMAGE_ANGEL_MODIFIER = 0.2f;

    private static final int DARK_ANGEL_DAMAGE = 30;

    private static final float DRACULA_MODIFIER = -0.3f;
    private static final int DRACULA_DAMAGE = 40;

    private static final float GOOD_BOY_MODIFIER = 0.5f;
    private static final int GOOD_BOY_HEAL = 30;

    private static final float LEVEL_UP_ANGEL_MODIFIER = 0.2f;

    private static final int LIFE_GIVER_HEAL = 80;

    private static final float SMALL_ANGEL_MODIFIER = 0.15f;
    private static final int SMALL_ANGEL_HEAL = 15;

    private static final int SPAWNER_RESURRECT_HEALTH = 150;

    private static final int XP_ANGEL_BONUS_XP = 50;
